...
public class KafkaConsumerConfig {
    ...
    public ConsumerFactory<String, Greeting> greetingConsumerFactory() {
        ...
        final JsonDeserializer<Greeting> valueDeserializer = new JsonDeserializer<Greeting>(Greeting.class);
        valueDeserializer.addTrustedPackages("com.mrk.kafka.models");
